...
module.exports = function (grunt) {
  ...
  this.createPackageJSON = function (shim) {
    ...
    pkg.config.shimney = {
      moduleID: shim.moduleID
    };

    if (shim.assets) {
      pkg.config.shimney.assets = shim.assets;
    }
  ...
  this.publish = function (shim, done, republish) {
    this.npmInit(done, {force: republish}, function(npmError) {
